...
![alt](https://img.shields.io/github/contributors/Shyroe/tindev.svg?style=flat&color=orange)
![alt](https://img.shields.io/github/forks/Shyroe/tindev.svg?color=orange)
...
- Register users with github perfil
- This application work with real time integration
- Match users in real time and multiplatform integration (web and mobile)
...
**Answer**: React; React native; Monogdb; Socket.io; axios; Nodejs with Express;
